...
public class Chunk
{
    ...
    List<int>     transperentTriangles = new List<int>();
    ...
    void UpdateMeshData(Vector3 pos)
    {
        ...
        for (int p = 0; p < 6; p++)
        {
            if (CheckVoxel(pos + VoxelData.faceChecks[p]))
            {
                ...
                {
                    transperentTriangles.Add(vertexIndex);
                    transperentTriangles.Add(vertexIndex + 1);
                    transperentTriangles.Add(vertexIndex + 2);
                    transperentTriangles.Add(vertexIndex + 2);
                    transperentTriangles.Add(vertexIndex + 1);
                    transperentTriangles.Add(vertexIndex + 3);
                }
    ...
    public void CreateMesh()
    {
        ...
        mesh.SetTriangles(transperentTriangles.ToArray(), 1);
